        ...
        <div class="row">
            <div class="col-md-8">
                ...
                $offset = ($page - 1) * $limit;
                    ...
                    $sql = "SELECT post.post_id, post.title, post.description, post.post_img, post.category,post.author, post.post_date,
                    category.category_name,user.username FROM post LEFT JOIN 
